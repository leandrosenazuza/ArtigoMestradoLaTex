...
\titulo{Protótipo de criação de Sistema de Realidade Virtual a partir de um ESP32 e Sensores de baixo custo}
%\tituloestrangeiro{Canonical article template in \abnTeX: optional foreign title}

\autor{
Laboratório de Computação Gráfica \thanks{``Recomenda-se que os dados de vinculação e
...
\\[0.5cm] 
Leandro Sena Zuza\thanks{``Constar currículo sucinto de cada autor, com 
...
\hypersetup{
		...
		pdftitle={\@title}, 
		pdfauthor={\@author},
    	pdfsubject={Protópio de Sistema de Realidade Virtual utilizando ESP32},
